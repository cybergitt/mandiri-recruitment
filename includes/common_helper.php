 ...
 * Upload Doc
 *
 * Function for uploading media files, currently only supported for pdf, word, odt or rtf document format
 *
 * @return	File Doc Uploaded
 */
function uploadDocs($file, $prefix, $destination){
    $uploadDirectory = ABSPATH . UPLOADS_DIR;

    $errors = []; // Store all foreseen and unforseen errors here

    $fileExtensions = ['doc','docx','odt','pdf']; // Get all the file extensions
